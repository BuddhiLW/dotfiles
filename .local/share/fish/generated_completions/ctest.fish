...
complete -c ctest -l resource-spec-file -d 'Run CTest with \\%resource allocation enabled, using the \\%resource specificat…'
complete -c ctest -l test-load -d 'While running tests in parallel (e. g'
complete -c ctest -s Q -l quiet -d 'Make CTest quiet. sp This option will suppress all the output'
complete -c ctest -s O -l output-log -d 'Output to log file'
complete -c ctest -l output-junit -d 'Write test results in JUnit format'
...
complete -c ctest -l test-output-size-passed -d 'New in version 3. 4. sp Limit the output for passed tests to <size> bytes'
complete -c ctest -l test-output-size-failed -d 'New in version 3. 4. sp Limit the output for failed tests to <size> bytes'
...
complete -c ctest -l no-tests -d 'Regard no tests found either as error or ignore it'
complete -c ctest -l help -o help -o usage -s h -s H -d 'Print usage information and exit'
complete -c ctest -l version -o version -d 'Show program name/version banner and exit'
...
complete -c ctest -l build-and-test -d 'See %Build and Test Mode'
complete -c ctest -l test-dir -d 'Specify the directory in which to look for tests'
