...
complete -c homectl -l luks-cipher -l luks-cipher-mode -l luks-volume-key-size -l luks-pbkdf-type -l luks-pbkdf-hash-algorithm -l luks-pbkdf-time-cost -l luks-pbkdf-memory-cost -l luks-pbkdf-parallel-threads
