...
complete -c cmake -o Werror -d 'Make developer warnings errors'
complete -c cmake -o Wno-error -d 'Make developer warnings not errors'
...
complete -c cmake -l list-presets -l list-presets -d 'Lists the available presets'
complete -c cmake -l build -d 'Project binary directory to be built'
complete -c cmake -l parallel -s j -d 'The maximum number of concurrent processes to use when building'
complete -c cmake -l target -s t -d 'Build <tgt> instead of the default target'
...
complete -c cmake -l verbose -s v -d 'Enable verbose output - if supported - including the build commands to be exe…'
