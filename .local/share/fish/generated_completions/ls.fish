...
complete -c ls -l color -d 'color the output WHEN; more info below'
...
complete -c ls -s f -d 'list all entries in directory order'
complete -c ls -s F -l classify -d 'append indicator (one of */=>@|) to entries WHEN'
...
complete -c ls -s k -l kibibytes -d 'default to 1024-byte blocks for file system usage; used only with -s and per …'
