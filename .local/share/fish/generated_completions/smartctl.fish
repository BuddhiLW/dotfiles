...
complete -c smartctl -s a -l all -d 'Prints all SMART information about the disk'
...
complete -c smartctl -s n -l nocheck -d '[ATA] [SCSI: NEW EXPERIMENTAL SMARTCTL FEATURE] Specifies if smartctl should …'
