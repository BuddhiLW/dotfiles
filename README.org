...
=M-d= will open the PDF for consulting. 

Note: Modifying it and building your own version should be as easy as:`vim $DOTFILES/.config/documentation/xmonad-bindings-tables.md && dotdoc-compile`
