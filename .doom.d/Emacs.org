...
#+RESULTS:
| doom--setq-tab-width-for-python-mode-h | er/add-python-mode-expansions | indent-bars-mode | doom-modeline-env-setup-python | +python-use-correct-flycheck-executables-h | evil-collection-python-set-evil-shift-width | doom--enable-+web-django-mode-in-python-mode-h | pipenv-mode |
