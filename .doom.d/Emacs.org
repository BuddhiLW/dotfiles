...
TODO: fix:
#+begin_quote
../../.emacs.d/.local/straight/build-30.0.91/company-go/company-go.el: Warning: ‘case’ is an obsolete alias (as of 27.1); use ‘cl-case’ instead.
#+end_quote
...
#+RESULTS:
| doom--setq-tab-width-for-python-mode-h | er/add-python-mode-expansions | lsp-deferred | indent-bars-mode | doom-modeline-env-setup-python | +python-use-correct-flycheck-executables-h | evil-collection-python-set-evil-shift-width | doom--enable-+web-django-mode-in-python-mode-h | pipenv-mode |
