...
#+RESULTS:
| my/cider-font-lock-reset | evil-normalize-keymaps | +clojure--cider-disable-completion | eldoc-mode | doom-modeline-update-cider | my/cider-font-recover |
...
#+RESULTS:
: #s(gptel-ollama "Ollama" "localhost:11434" nil "http" t "/api/chat" nil (deepseek-r1:latest) "http://localhost:11434/api/chat" nil nil)
...
** ELLAMA
Use =ollama= inside Emacs the way the like it!
...
#+RESULTS:
| #[nil ((unless cider-mode (cider-mode 1))) nil] | er/add-clojure-mode-expansions | cider-mode | #<subr F616e6f6e796d6f75732d6c616d626461_anonymous_lambda_102> | clojure--check-wrong-major-mode | #[nil ((if cider-mode nil (cider-mode 1))) nil] | lsp-deferred | indent-bars-mode | rainbow-delimiters-mode | parinfer-rust-mode |
